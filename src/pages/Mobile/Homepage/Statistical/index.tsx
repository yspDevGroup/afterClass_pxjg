  ...
  return (
    <div className={styles.statisticalPage}>
      <div className={styles.topText}>
        <span>
          {getTerm()?.XN} {getTerm()?.XQ}
        </span>
        <Tabs
          className={styles.theTabs}
        ...
        >
            ...
            tab={
              <div>
                <div className={styles.iconContainer}>
                  <IconFont className={styles.iconStyle} type={'icon-baoming'} />
                </div>
          ...
          <TabPane
            tab={
              <div>
                <div className={styles.iconContainer}>
                  <IconFont className={styles.iconStyle} type={'icon-shoufei'} />
                </div>
          ...
          <TabPane
            tab={
              <div>
                <div className={styles.iconContainer}>
                  <IconFont className={styles.iconStyle} type={'icon-kaoqin'} />
                </div>
          ...
          <TabPane
            tab={
              <div>
                <div className={styles.iconContainer}>
                  <IconFont className={styles.iconStyle} type={'icon-kecheng'} />
                </div>
